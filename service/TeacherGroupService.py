...
from small_data.TeacherComparator import TeacherComparator
...
class TeachersGroupService:
    ...
    def createTeachersGroup(self, teacher: List[Teacher], students: Student):
    ...
    def getSortedByFIOTeachersGroup(self):
        self.teachers: List[Teacher] = list(self.__teachers_group.getTeachers())
        self.teachers.sort(TeacherComparator())
        return self.teachers