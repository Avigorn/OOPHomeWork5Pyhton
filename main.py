...
from small_data.StudyGroupIterator import StudyGroupIterator
...
def testIterator(student_group: StudentGroup, teachers_group: TeachersGroup):
    ...
    # study_group_iterator = StudyGroupIterator(study_group)
    while student_group_iterator.hasNext() or teachers_group_iterator.hasNext():
        ...
        # print(study_group_iterator.next())
...
class Main:
    ...
    teacher1 = Teacher("Vasiliy", "Smirnov", "Petrovich", 1)
    teacher2 = Teacher("Arkadiy", "Smirnoff", "Al'bertovich", 2)
    ...
    # study_group = StudyGroup(teacher1, group_of_students)
